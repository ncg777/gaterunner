    ...
    <v-card class="pa-4 bg-black">
      ...
      <v-card-text class="pa-4">
        ...
        <ul>
          ...
          <li><strong>Frozen noise spectra</strong>: Pink and brown spectrum waveforms use deterministic signed coefficients across 64 harmonics, shaped by 1/√h and 1/h amplitude envelopes. They are periodic and follow note pitch, so they support the spectrum preview, waveform transforms, unison, and multidimensional wavetable crossfades.</li>
